...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_maptier", Command_MapTier, ADMFLAG_ROOT, "sm_maptier [bonus] [tier]");
	RegAdminCmd("sm_stagecount", Command_StageCount, ADMFLAG_ROOT, "sm_stagecount [bonus]");
